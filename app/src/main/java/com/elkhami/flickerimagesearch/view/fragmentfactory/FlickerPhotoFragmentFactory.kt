...
class FlickerPhotoFragmentFactory @Inject constructor(
    ...
    override fun instantiate(classLoader: ClassLoader, className: String): Fragment {
        return when (className) {
            ...
            DisplayPhotoFragment::class.java.name -> DisplayPhotoFragment(glide, dbMapper)
            SavedPhotosFragment::class.java.name -> SavedPhotosFragment(savedPhotoAdapter, dbMapper)
